...
public class PowerPlayTeleOpTest extends OpMode {
...
private robot teleRobot;
    ...
    public void loop(){
        ...
        if(rightBumper1) {
            teleRobot.leftFrontMotor.setPower(0.75);
            teleRobot.rightFrontMotor.setPower(-0.75);
            teleRobot.leftBackMotor.setPower(-0.75);
            teleRobot.rightBackMotor.setPower(0.75);
        } else if(leftBumper1) {
            teleRobot.leftFrontMotor.setPower(-0.75);
            teleRobot.rightFrontMotor.setPower(0.75);
            teleRobot.leftBackMotor.setPower(0.75);
